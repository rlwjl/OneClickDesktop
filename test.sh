...
GUACAMOLE_DOWNLOAD_LINK="https://github.com/rlwjl/OneClickDesktop/raw/master/guacamole-server-1.2.0.tar.gz"
...
{
	curl -s https://github.com/rlwjl/OneClickDesktop/raw/master/apache-tomcat-9.0.38.tar.gz | tar -xz
...
function install_guacamole_web
{
	...
	cd $CurrentDir
	wget https://archive.apache.org/dist/guacamole/$GUACAMOLE_VERSION/binary/guacamole-$GUACAMOLE_VERSION.war
